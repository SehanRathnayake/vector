...
<body>
<div>
    <section id="CUS_customerListContainer" style="margin-top: 8%;">
        <div class="container">
            <div class="row">
                <div class="well-sm ">
                    ...
                    <div class="col-lg-3 col-sm-3">
                        <input id="CUS_customerName"></input>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section id="CUS_customerDetailContainer" style="display: none;margin-top: 8%;">
                ...
                <div>
                    <div class="container well">
                        <div class="row vector-row">
                            ...
                            <input id="customerId" class="col-lg-3 col-sm-3" disabled/></div>
                    </div>
                    <div class="container well">
                        <div class="row vector-row">
                            <div class="col-lg-3 col-sm-3">
                            ...
                            <input id="customerName" class="customer-input col-lg-3 col-sm-3"></div>
                    </div>
                    <div class="container well">
                        <div class="row vector-row">
                            <div class="col-lg-3 col-sm-3">
                            ...
                            <input id="customerAddress" class="customer-input col-lg-3 col-sm-3"></div>
                    </div>
                    <div class="container well">
                        <div class="row vector-row">
                            <div class="col-lg-3 col-sm-3">
                            ...
                            <input id="customerEmail" class="customer-input col-lg-3 col-sm-3" type="email"></div>
                    </div>
                    <div class="container well">
                        <div class="row vector-row">
                            <div class="col-lg-3 col-sm-3">
                            ...
                            <input id="customerTelephone" class="customer-input col-lg-3 col-sm-3"></div>
                    </div>
                </div>
            </div>
            <div id="vehicleDiv">
...
">Vehicle Details</div>
                    ...
                    <div class="">
                        ...
                        <div class="container well">
                            <div class="row vector-row">
                                ...
                                <input id="manufactDate1" class="col-lg-3 col-sm-3 customer-input" type="number"
                                       min="1980" max="2017" disabled>
                            </div>
                        </div>
                        <div class="container well">
                            <div class="row vector-row">
    ...
    <section id="CUS_addCustomer" style="display: none;margin-top: 8%;">
        ...
        <form role="form" id="CUS_addVehicleForm" onsubmit="return false;">
            ...
            <div class="container well">
                <div class="row vector-row"><label for="numberPlate11" class="col-lg-3 col-sm-3">Number
                    plate</label><input id="numberPlate11" class="col-lg-3 col-sm-3" type="text" required></div>
            </div>
            <div class="container well">
                <div class="row vector-row"><label for="manufactDate11" class="col-lg-3 col-sm-3">Manufact
                    year</label><input id="manufactDate11" class="col-lg-3 col-sm-3" type="number" min="1980" max="2017"
                                       required></div>
            </div>
            <div class="container well">
                <div class="row vector-row"><label for="addModel11" class="col-lg-3 col-sm-3">Model</label>
                    <form id="addModel11"><select name="item" id="CUS_addVehicleModel" class="col-lg-3 col-sm-3">
                        <option value="abc">abc</option>
                        <option value="abcd">abcd</option>
                        <option value="abcde">abcde</option>
                    </select></form>
