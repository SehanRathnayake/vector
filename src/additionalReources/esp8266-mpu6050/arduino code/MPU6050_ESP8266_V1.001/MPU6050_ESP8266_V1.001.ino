...
const char* ssid = "anjana";
const char* password = "0412240390";
...
void loop() {
  ...
  //Serial.print("AcX = "); Serial.print(dataX.get<unsigned int>(arrayIndex));
  //Serial.print(" | AcY = "); Serial.print(dataY.get<unsigned int>(arrayIndex));
  //Serial.print(" | AcZ = "); Serial.println(dataZ.get<unsigned int>(arrayIndex));
